    ...
    <div class="app-container home">
        ...
        <el-row :gutter="20">
            <el-col :sm="24" :lg="12" style="padding-left: 20px">
                <h2>智慧物业管理框架</h2>
                <p>
                    一直想做一款管理系统，看了很多优秀的开源项目但是发现没有合适自己的。于是利用空闲休息时间开始自己写一套系统。如此有了智慧物业管理系统。，她可以用于所有的Web应用程序，如网站管理，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
                </p>
                <p>
                    <b>当前版本:</b>
                    <span>v{{ version }}</span>
                ...
                <el-card class="update-log">
                    ...
                    <div class="body">
                        ...
                        <p>
                            ...
                            微信：
                            <a href="javascript:;">/ *智慧物业</a>
                        </p>
                        <p>
                            <i class="el-icon-money"></i>
                            支付宝：
                            <a href="javascript:;" class="支付宝信息">/ *智慧物业</a>
                        </p>
                    </div>
                </el-card>
            </el-col>
